...
jsPsych.plugins["image-instructions"] = (function () {
  var plugin = {};
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      images: {
        ...
        array: true,
        description:
          "Each element of the array is the image shown at the button of a single page.",
      },
      key_forward: {
  ...
  plugin.trial = function (display_element, trial) {
    console.assert(trial.pages.length == trial.images.length);
    ...
    function show_current_page() {
      ...
      if (trial.images[current_page] !== null) {
        var image_html = `<img id="jspsych-instructions-image" src="${trial.images[current_page]}" style="margin: 25px 0;">`;
      } else {
        var image_html = "";
      }
