/**
 * jspsych-html-button-keyboard-response
 * Roland Zimmermann
 *
 * plugin for displaying a stimulus and getting a keyboard response or a button response
 *
 **/

jsPsych.plugins["html-button-keyboard-response"] = (function () {
  var plugin = {};
  ...
  plugin.trial = function (display_element, trial) {
    ...
    if (trial.keyboard_choices != jsPsych.NO_KEYS) {
      var keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
        callback_function: function (e) {
          let idx = trial.keyboard_choices.indexOf(e.key);
          let choice = display_element
            .querySelector("#jspsych-html-button-response-button-" + idx)
