  ...
  core.init = function(options) {
    function init() {
      ...
      var defaults = {
        ...
        'preload_progress_bar_info_text': '<p>The experiment is loading. <br>You will be compensated for this waiting time.</p>',
        'max_load_time': 60000,
      ...
      checkExclusions(opts.exclusions,
        function(){
          ...
          if(opts.auto_preload){
            jsPsych.pluginAPI.autoPreload(timeline, startExperiment, file_protocol, opts.preload_images, opts.preload_audio, opts.preload_video, opts.show_preload_progress_bar, opts.preload_progress_bar_info_text);
...
jsPsych.data = (function() {
  ...
  module.getAllData = function() {
    return allData.filterCustom(x => true);
  }
...
jsPsych.turk = (function() {
  ...
  module.submitToTurk = function(data, mode="POST") {
...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, file_protocol, images, audio, video, progress_bar,
    ...
    if(progress_bar){
      var pb_html = progress_bar_info_text;
      pb_html += "<div id='jspsych-loading-progress-bar-container' style='height: 10px; width: 300px; background-color: #ddd; margin: auto;'>";
